...
import 'package:mi_nave_driver/pay_screen.dart';
import 'package:mi_nave_driver/time_select.dart';
import 'Theme/colors.dart';
import 'chat.dart';

class TerminarViaje extends StatefulWidget {

  @override
  _TerminarViajeState createState() => _TerminarViajeState();
}

class _TerminarViajeState extends State<TerminarViaje> {
                        ...
                        RaisedButton(
                          ...
                          child: Container(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text("Terminar viaje", style: TextStyle(color: whiteColor, fontSize: 18),),
                                ],
                              )),
                        )
                      ],

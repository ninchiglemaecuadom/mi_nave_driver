...
import 'package:mi_nave_driver/iniciar_viaje.dart';
import 'package:mi_nave_driver/time_select.dart';
import 'Theme/colors.dart';
import 'chat.dart';

class Llegue extends StatefulWidget {

  @override
  _LlegueState createState() => _LlegueState();
}

class _LlegueState extends State<Llegue> {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: RaisedButton(
                      ...
                      child: Text("¿Cómo llegar?", style: TextStyle(color: whiteColor),),
                      // child: const Icon(Icons.gps_fixed, size: 36.0, color: Color(0xffb4c0099),),
                    ),
                  ),
                  Container(
                            ...
                            RaisedButton(
                              ...
                              onPressed: (){
                                ...
                                Navigator.pushAndRemoveUntil(
                                    context,
                                    MaterialPageRoute(builder: (context) => IniciarViaje()),
                                    ModalRoute.withName("/IniciarViaje"));
                              ...
                              child: Container(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      Text("Llegué", style: TextStyle(color: whiteColor, fontSize: 18),),
                                    ],
                                  )),
                            )
                          ],
